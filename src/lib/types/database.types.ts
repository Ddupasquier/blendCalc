	...
	public: {
		Tables: {
			...
			catalog_conflict_review_dispositions: {
				...
				Relationships: [
					{
						foreignKeyName: "catalog_conflict_review_dispositions_conflict_id_fkey";
						columns: ["conflict_id"];
						isOneToOne: false;
						referencedRelation: "catalog_actionable_product_conflicts";
						referencedColumns: ["id"];
					},
					{
						foreignKeyName: "catalog_conflict_review_dispositions_conflict_id_fkey";
					...
					{
						foreignKeyName: "catalog_conflict_review_dispositions_shared_product_id_fkey";
						columns: ["shared_product_id"];
						isOneToOne: false;
						referencedRelation: "blendcalc_api_catalog_product_readiness";
						referencedColumns: ["shared_product_id"];
			...
			catalog_correction_origins: {
				...
				Relationships: [
					...
					},
					{
						...
						isOneToOne: false;
						referencedRelation: "catalog_actionable_provider_change_reviews";
						referencedColumns: ["id"];
					},
					{
						foreignKeyName: "catalog_correction_origins_provider_change_review_id_fkey";
		...
		Views: {
			...
			catalog_actionable_provider_change_reviews: {
				Row: {
					accepted_revision_id: string | null;
					change_summary: Json | null;
					created_at: string | null;
					id: string | null;
					material_field_paths: string[] | null;
		...
		Functions: {
			...
			apply_deterministic_food_warning_decision: {
			...
			finish_catalog_conflict_review: {
				Args: { p_decisions: Json; p_shared_product_id: string };
				Returns: Json;
			};
