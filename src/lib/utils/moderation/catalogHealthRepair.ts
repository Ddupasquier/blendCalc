...
const CATALOG_REPAIR_REASON_LABELS: Record<string, string> = {
	...
	canonical_value_missing:
		"The current product value is missing, so there is nothing safe to link.",
	exact_observation_revision_baseline:
		"An exact stored source record can restore the first catalog revision.",
	exact_nutrient_match:
		"An exact reusable source record matches this nutrition value.",
	exact_revision_baseline_evidence_missing:
		"No exact stored record can safely reconstruct the first catalog revision.",
	exact_serving_match: "An exact reusable source record matches this serving.",
	exact_submission_revision_baseline:
		"An approved matching submission can restore the first catalog revision.",
	exact_value_match:
		"An exact reusable source record matches this product information.",
	no_exact_redistributable_observation:
		"No exact reusable source record matches the current value.",
	primary_serving_missing:
		"This product does not have a primary serving to verify.",
	...
	repair_handler_not_available:
		"This issue does not have a safe automated repair yet.",
	structured_revision_change_available:
		"The stored revision summary contains enough exact detail to restore its change history.",
	structured_revision_change_evidence_missing:
		"The stored revision summary does not contain enough exact detail to reconstruct what changed.",
};
