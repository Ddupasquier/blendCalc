...
const CATALOG_ISSUE_CODE_LABELS: Record<string, string> = {
	...
	CATALOG_FIELD_PROVENANCE_MISSING: "Product information is missing source evidence",
	CATALOG_GTIN_INVALID: "Product GTIN is invalid",
	CATALOG_MATERIAL_CONFLICT: "Product information has an unresolved conflict",
	CATALOG_NUTRIENT_DERIVATION_INCOMPLETE: "Calculated nutrition is missing its method",
	CATALOG_NUTRIENT_PROVENANCE_MISSING: "Nutrition is missing source evidence",
	CATALOG_NUTRIENT_VALUE_UNSUPPORTED: "A nutrient reporting state is unsupported",
	...
	CATALOG_SERVING_PROVENANCE_MISSING: "Serving information is missing source evidence",
...
const CATALOG_RESOLUTION_ACTION_LABELS: Record<string, string> = {
	...
	run_nutrient_provenance_repair: "Repair nutrient provenance from existing evidence",
	...
	run_serving_provenance_repair: "Repair serving provenance from existing evidence",
};
...
export const getCatalogResolutionActionLabel = (resolutionAction: string) =>
	CATALOG_RESOLUTION_ACTION_LABELS[resolutionAction] ?? "Review the available evidence";
