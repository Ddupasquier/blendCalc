...
export type ProductReferenceCatalog = {
...
export const getCanonicalProductNutrientId = (
	...
	findCanonicalNutrientDefinition(
		productReferenceCatalog.nutrientEquivalences,
		nutrientId,
		nutrientNumber,
...
export const readProductReferenceCatalog = async (
	supabase: SupabaseClient<Database>,
	nutrientDefinitions?: NutrientDefinitionReferenceRecord[],
): Promise<ProductReferenceCatalog> => {
...
export const getProductDataSource = (
	...
	const source = productReferenceCatalog.sources[key];
