import type {
	ModeratorActionInformation,
	ModeratorActionInformationKey,
} from "./types";

export const moderatorActionInformationByAction = {
	"product-submissions": {
...
} satisfies Record<ModeratorActionInformationKey, ModeratorActionInformation>;
