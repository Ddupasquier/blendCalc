<script lang="ts">
	...
	import FruitIcon from "$lib/components/illustrations/fruit/FruitIcon/FruitIcon.svelte";
	import {
	...
	import type { FloatingFruitBackgroundProps } from "./types";

	let { focusElement }: FloatingFruitBackgroundProps = $props();
...
<style lang="scss">
	@use "./FloatingFruitBackground.scss";
</style>
