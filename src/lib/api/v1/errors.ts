export const API_V1_ERROR_DEFINITIONS = {
...
export type ApiV1ErrorCode = keyof typeof API_V1_ERROR_DEFINITIONS;

export const readApiV1ErrorDefinition = (code: ApiV1ErrorCode) =>
	API_V1_ERROR_DEFINITIONS[code];

export const isApiV1Pathname = (pathname: string) =>
