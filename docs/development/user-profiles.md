...
- Bio and profile image remain optional. The shared field, server validation,
  owner-scoped database function, and table constraint limit bios to 150 characters.
