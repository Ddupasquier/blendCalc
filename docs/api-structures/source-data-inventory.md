...
| Canadian Nutrient File 2026 | Generic-food identity, groups, preparations, nutrients, units, measures, release metadata | Imported through `scripts/imports/import_cnf_2026.mjs`; approved storage terms are recorded in `generic_food_datasets` |
| UK CoFID 2021 | Generic-food identity, groups, preparations, nutrients, units, measures, release metadata | Imported through `scripts/imports/import_cofid_2021.mjs`; approved storage terms are recorded in `generic_food_datasets` |
