...
route relays the current FDA announcement index and FDA recall details only when the
Edge runtime cannot reach FDA.gov directly; it is not a general web proxy.
