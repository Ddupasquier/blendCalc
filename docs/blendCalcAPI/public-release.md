# Public blendCalcAPI Release Review
...
Public access remains blocked in
`src/lib/blendCalcAPI/v1/blendCalcAPIAccessPolicy.ts` and the OpenAPI status
...
4. The private-data inventory and API serializer boundary described in
   ...
   [`catalog-field-lineage.md`](catalog-field-lineage.md).
...
7. The complete app privacy inventory for account, profile, food-preference, recipe,
   ...
   fields returned by blendCalcAPI v1.
