 ...
 * Preview: `node scripts/backfills/catalog/backfill_source_food_details.mjs --dry-run`
 * Execute: `node scripts/backfills/catalog/backfill_source_food_details.mjs`
 * Limit: `node scripts/backfills/catalog/backfill_source_food_details.mjs --dry-run --limit=10`
 */
