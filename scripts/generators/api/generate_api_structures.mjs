 ...
 *
 * API: ${apiName}
 * Generated by: scripts/generators/api/generate_api_structures.mjs
...
When new external food APIs are added to the app, update \`scripts/generators/api/generate_api_structures.mjs\` so this folder continues to reflect every active external data source.
`,
	);
};
