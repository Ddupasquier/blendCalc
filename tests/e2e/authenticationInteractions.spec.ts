...
test("email authentication switches modes without stale credential fields", async ({
	context,
	page,
}) => {
...
test("password recovery uses the shared labeled credential controls", async ({
	page,
}) => {
