...
const sharedImporter = readFileSync(
	"scripts/lib/nutrition/nutrition_dataset_import.mjs",
	"utf8",
);
const importers = [
	readFileSync("scripts/imports/nutrition/import_cnf_2026.mjs", "utf8"),
	readFileSync("scripts/imports/nutrition/import_cofid_2021.mjs", "utf8"),
];
