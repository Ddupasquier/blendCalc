...
export const appReferenceCatalogFixture: AppReferenceCatalog = {
	...
	foodSymbols: [
		...
		{ key: "seafood", label: "Fish and seafood" },
		{ key: "grains", label: "Grains" },
		{ key: "bread-bakery", label: "Bread and bakery" },
		{ key: "pasta-noodles", label: "Pasta and noodles" },
		{ key: "legumes", label: "Legumes" },
		{ key: "nuts-seeds", label: "Nuts and seeds" },
		{ key: "beverage", label: "Beverage" },
		{ key: "coffee-tea", label: "Coffee and tea" },
		{ key: "sweets", label: "Sweets" },
		{ key: "frozen-dessert", label: "Frozen desserts" },
		{ key: "spreads-preserves", label: "Spreads and preserves" },
		{ key: "oils-fats", label: "Oils and fats" },
		{ key: "sauces-condiments", label: "Sauces and condiments" },
		{ key: "soup", label: "Soup and stew" },
		{ key: "protein-powder", label: "Protein powder" },
		{ key: "protein-bar", label: "Protein and nutrition bars" },
		{ key: "packaged", label: "Packaged food" },
	],
