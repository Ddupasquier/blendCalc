		...
		[
			{
				symbolKey: "fruit",
				matchPattern:
					"(^|[^a-z])(fruits and fruit juices|fruit products)([^a-z]|$)",
				priority: 1000,
			...
			},
			{
				...
				matchPattern:
					"(^|[^a-z])(vegetables and vegetable products|vegetable products)([^a-z]|$)",
				priority: 1010,
				matchScopes: ["category"],
			},
			{
				symbolKey: "meat",
				matchPattern:
					"(^|[^a-z])(meat products|beef products|pork products)([^a-z]|$)",
				priority: 1020,
				matchScopes: ["category"],
			},
			{
				symbolKey: "seafood",
				matchPattern:
					"(^|[^a-z])(finfish and shellfish products|seafood products)([^a-z]|$)",
				priority: 1030,
				matchScopes: ["category"],
			},
			{
			...
			{
				symbolKey: "salad",
				matchPattern: "(^|[^a-z])salad([^a-z]|$)",
				priority: 2,
			},
			{
				symbolKey: "sandwich",
				matchPattern: "(^|[^a-z])sandwich([^a-z]|$)",
				priority: 3,
			},
			{
				symbolKey: "chips",
				matchPattern: "(^|[^a-z])(tortilla chips|potato chips)([^a-z]|$)",
				priority: 3,
			},
			{
				symbolKey: "food-bowl",
				matchPattern: "(^|[^a-z])(poke|grain bowl)([^a-z]|$)",
				priority: 3,
			},
			{
				symbolKey: "bread",
				matchPattern: "(^|[^a-z])(bread|toast)([^a-z]|$)",
				priority: 4,
			},
			{
				symbolKey: "pasta",
				matchPattern: "(^|[^a-z])(pasta|spaghetti)([^a-z]|$)",
				priority: 5,
			},
			{
				symbolKey: "noodle-soup",
				matchPattern: "(ramen|pho|noodle soup)",
				priority: 5,
			},
			{
				symbolKey: "nuts-seeds",
				matchPattern: "(peanut butter|nut butter|seed butter)",
				priority: 9,
			},
			{
				symbolKey: "hummus",
				matchPattern: "(^|[^a-z])hummus([^a-z]|$)",
				priority: 9,
			},
			{ symbolKey: "protein-bar", matchPattern: "(protein bar)", priority: 10 },
			{
				symbolKey: "oils-fats",
				matchPattern: "(^|[^a-z])(oil|butter)([^a-z]|$)",
				priority: 11,
			},
			{
				symbolKey: "beer",
			...
			{
				symbolKey: "wine",
				matchPattern: "(^|[^a-z])(wine|merlot|chardonnay)([^a-z]|$)",
				priority: 13,
			},
			{
				symbolKey: "spirits",
				matchPattern: "(^|[^a-z])(whiskey|vodka|rum|gin)([^a-z]|$)",
				priority: 14,
			},
			{
				symbolKey: "kombucha",
				matchPattern: "(^|[^a-z])kombucha([^a-z]|$)",
				priority: 15,
			},
			{
				symbolKey: "coffee",
				matchPattern: "(^|[^a-z])(coffee|espresso)([^a-z]|$)",
				priority: 16,
			},
			{
				symbolKey: "coffee-tea",
				matchPattern: "(^|[^a-z])tea([^a-z]|$)",
				priority: 17,
			},
			{
				symbolKey: "spreads-preserves",
			...
			{
				symbolKey: "shellfish",
				matchPattern: "(shellfish|shrimp|crab)",
				priority: 59,
			},
			{
				symbolKey: "salmon",
				matchPattern: "(^|[^a-z])salmon([^a-z]|$)",
				priority: 51,
			},
			{
				symbolKey: "tuna",
				matchPattern: "(^|[^a-z])tuna([^a-z]|$)",
				priority: 50,
			},
			{
				symbolKey: "duck",
				matchPattern: "(^|[^a-z])duck([^a-z]|$)",
				priority: 51,
			},
			{
				symbolKey: "milk",
				matchPattern: "(^|[^a-z])milk([^a-z]|$)",
				priority: 51,
			},
			{
				symbolKey: "spinach",
				matchPattern: "(^|[^a-z])spinach([^a-z]|$)",
				priority: 51,
			},
			{
				symbolKey: "potato",
				matchPattern: "(^|[^a-z])potato([^a-z]|$)",
				priority: 51,
			},
			{
				symbolKey: "lamb-game",
				matchPattern: "(^|[^a-z])(lamb|goat|venison)([^a-z]|$)",
				priority: 60,
			},
			{
			...
			{
				symbolKey: "banana",
				matchPattern: "(^|[^a-z])banana([^a-z]|$)",
				priority: 71,
			},
			{
				symbolKey: "avocado",
				matchPattern: "(^|[^a-z])avocado([^a-z]|$)",
				priority: 72,
			},
			{
				symbolKey: "mushrooms",
				matchPattern: "(mushroom|shiitake)",
				priority: 73,
			},
			...
			{
				symbolKey: "fruit",
				matchPattern: "(fruit|apple|banana)",
				priority: 90,
			},
			{
				symbolKey: "sweets",
				matchPattern: "(sweet|candy|syrup)",
				priority: 100,
			},
		] satisfies Array<
...
const nutritionAssessmentPolicyFixture = {
	assessmentPolicyKey: "exact-barcode-resolution-v1",
	exactSourceScore: 3,
	mappedSourceScore: 2,
...
export const nutritionCompletenessCatalogFixture: NutritionCompletenessCatalog =
	{
		profiles: [
			{
				key: "generic-core-v1",
				...nutritionAssessmentPolicyFixture,
...
export const productReferenceCatalogFixture: ProductReferenceCatalog = {
	...
	nutrientMappings: [
		...
		mapping("calcium", NUTRIENT_IDS.CALCIUM, "Calcium, Ca", "301", "MG", "G"),
		mapping("calcium", NUTRIENT_IDS.CALCIUM, "Calcium, Ca", "301", "MG"),
		mapping("iron", NUTRIENT_IDS.IRON, "Iron, Fe", "303", "MG", "G"),
		mapping(
			"potassium",
		...
		mapping("vitamin-d", 1114, "Vitamin D (D2 + D3)", "328", "UG", "G"),
	...
	nutrientConversions: [
		...
		...[
			...
			sourceKey: "open-food-facts" as const,
			nutrientId,
			fromUnitName: "G",
			toUnitName: "MG",
			multiplier: 1000,
