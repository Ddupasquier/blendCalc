...
comment on function public.get_catalog_monitor_moderation_summary(integer) is
	'Returns the bounded catalog-monitor queue, run, provider-change, and safety-match summary for MFA-verified moderators.';
